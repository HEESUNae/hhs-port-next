...
export const cardDesc = [
  {
    ...
    title: '스타벅스',
    subTitle: '스타벅스 커피를 소개하는 웹페이지 포트폴리오 (기여도 100%)',
  ...
  },
  {
    ...
    title: '고답 (고구마 답답이)',
    subTitle: '세상 모든 고구마들을 위한 고민상담 커뮤니티 포트폴리오 (기여도 100%)',
  ...
  },
  {
    ...
    title: 'CoverGirl',
    subTitle: 'CoverGirl 브랜드의 화장품 정보 소개하는 웹페이지 포트폴리오 (기여도 100%)',
  ...
  },
  {
    ...
    imageAlt: 'Pokemon GO',
    title: 'Pokemon',
    subTitle: '포켓몬을 잡고 합성할 수 있는 웹페이지 포트폴리오 (기여도 100%)',
